...
static constexpr uint8_t TAPROOT_LEAF_TAPSCRIPT_V2 = 0xc1;
...
bool EvalScript(ScriptStack& stack, const CScript& script, unsigned int flags, const BaseSignatureChecker& checker, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr, uint64_t* varops_budget = nullptr);
