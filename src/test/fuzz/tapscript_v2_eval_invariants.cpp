...
public:
    ...
    bool CheckSchnorrSignature(Span<const unsigned char>,
                               KeyVersion,
...
opcodetype ConsumeUsefulOpcode(FuzzedDataProvider& provider)
{
    return provider.PickValueInArray<opcodetype>({
        ...
        OP_CHECKSIGVERIFY, OP_CHECKSIGADD, OP_INTERNALKEY, OP_CHECKSIGFROMSTACK,
        OP_TEMPLATEHASH, OP_CODESEPARATOR,
    });
}
